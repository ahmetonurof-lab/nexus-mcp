...
## ✅ Done
- **Recovery tick_size fix canlıda doğrulandı (2026-08-08, commit `daaeeb0`):** Sunucu log incelemesi (run `paper-20260808-000537`): 0 ERROR/CRITICAL/Traceback, screen 366235.bot, HEAD daaeeb0. ALGO: trail#1 0.08901/0.08217 uygulandı (trail_count=1) → +19.96 SL kapanış — fix öncesi 170/170 recovered trade tick=0.1'de boğuluyordu, hop uygulanamıyordu. RENDER: 06:33 WS stale + -2021 onarım (guard çalıştı), trailing adayları fiyat üstünde olduğu için placeable değil (doğru); **08:49 web emri = kullanıcının manuel kapanışı** (qty 0.1 görünce) → TP pnl=0.00. Günlük: ARB +18.13, ADA -1.50, ALGO +19.96, RENDER 0.00. Açık pozisyon yok.
